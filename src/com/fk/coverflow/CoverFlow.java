...
public class CoverFlow extends Gallery {
	...
	private void parseAttributes(final Context context, final AttributeSet attrs) {
		...
		try {
			...
			imageReflectionRatio = a.getFloat(R.styleable.CoverFlow_imageReflectionRatio, 0.7f);
			reflectionGap = a.getDimension(R.styleable.CoverFlow_reflectionGap, 1);
			setSpacing(-55);
		} finally {
			a.recycle();
		}
